...
public class InkestaController {
    ...
    public void newComment(@RequestParam String user,@RequestParam String jokua,@RequestParam int question1,@RequestParam int question2,@RequestParam int question3,@RequestParam int question4  ){
    Inkesta inkesta = new Inkesta(user,jokua,question1,question2,question3,question4);
